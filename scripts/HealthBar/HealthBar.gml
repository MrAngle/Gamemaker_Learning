function my_draw_health_bar(_object) 
{
	if (instance_exists(_object) && 
        ...
        with(_object) {
            ...
            var bar_width = max(default_bar_width, sprite_width);  // Użyj większej wartości: domyślnej szerokości paska lub szerokości sprite'a
            ...
            // Ograniczenie szerokości paska zdrowia do maksymalnej szerokości
            if (health_width > bar_width) {
                health_width = bar_width;
            }
